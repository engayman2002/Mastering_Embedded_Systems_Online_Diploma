...
struct LinkedListNode
{
    ...
    struct LinkedListNode* PNextLinkedList;
};
...
extern Linked_List_Status Linked_List_AddNode(Linked_List_Node My_Head,element_type data);
...
extern Linked_List_Status Linked_List_Front(Linked_List_Node My_Head,element_type *data);
extern Linked_List_Status Linked_List_Back(Linked_List_Node My_Head,element_type *data);
...
extern Linked_List_Status Linked_List_NthNodeFromFront(Linked_List_Node My_Head,element_type *data,uint32_t index);
extern Linked_List_Status Linked_List_NthNodeFromBack(Linked_List_Node My_Head,element_type *data,uint32_t index);
